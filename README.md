A simple python script to write a cover letter using a the information from a CV text file, a Job Description from a job online and additional Notes using OpenAI API. 
